...
public:
			...
			void getEventToDeathMonster(EventCustom *eventCus);

			void getEventToCreateBullet(EventCustom *eventCus);

			void getEventToCrashBullet(EventCustom *eventCus);

			void getEventToDestroyBullet(EventCustom *eventCus);
			
			void getEventToTowerLoseLife(EventCustom *eventCus);

			void getEventToTowerDestroy(EventCustom *eventCus);
