...
public:
			...
			inline long getPlayerScore()noexcept { return _playerAcquireScoreForCell; };
			...
			void linkLineInGrid(const Vec2 & source, const Vec2 &dest);
			void unLinkLineInGrid();
			...
			int _cellPowerNum{ 0 };
			long _playerAcquireScoreForCell{ 0 };
