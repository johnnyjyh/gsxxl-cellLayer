...
{
			if(_cellLayer->getPlayerScore()!= m_recordCellScore && DefenseGameLogic::getInstance()!=nullptr)
			{
						DefenseGameLogic::getInstance()->acceptScore(_cellLayer->getPlayerScore() - m_recordCellScore);
