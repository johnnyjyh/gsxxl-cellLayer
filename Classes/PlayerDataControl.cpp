...
void PlayerDataControl::initRandEngine()
{
			...
			loadCellConfigJSon("level//cell//cell1.json");
			
			loadDefenseConfigJSon("level//defense//defense1.json");
...
{
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::MonsterCreate);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::MonsterWalk);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::TowerCreate);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners("DestoryBullet");
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::MonsterDeath);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::BulletCreate);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners(DefenseAnimationFile::BulletCrash);
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners("TowerLoseLife");
			Director::getInstance()->getEventDispatcher()->removeCustomEventListeners("TowerDestroy");
			if (eventCus == nullptr)
			{
